...
export function Header({ active = "" }: { active?: string }) {
  return <header className="site-header inner-header"><div className="container header-inner">
    ...
    <div className="header-actions"><a className="phone-pill" href="tel:+923207538028"><Icon name="phone" size={17}/>+92 320 7538028</a><Link className="button button-gold header-cta" href="/contact">Plan Your Trip</Link></div>
...
export function AdventureCta() {
  return <section className="cta-band"><div className="container adventure-cta"><div className="cta-icon"><Icon name="phone" size={27}/></div><div><h2>Ready to Start Your Adventure?</h2><p>Call or WhatsApp us now to plan your perfect trip.</p></div><a className="cta-number" href="tel:+923207538028">+92 320 7538028</a><a className="button button-gold" href="https://wa.me/923207538028"><Icon name="phone" size={18}/> Call / WhatsApp</a></div></section>;
}
...
export function SiteShell({ children, active }: { children: React.ReactNode; active?: string }) {
  return <main><Header active={active}/>{children}<AdventureCta/><Footer/><a className="mobile-whatsapp" href="https://wa.me/923207538028"><Icon name="phone" size={21}/>Plan Your Trip</a></main>;
}
